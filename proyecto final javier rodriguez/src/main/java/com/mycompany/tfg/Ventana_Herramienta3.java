 ...
 * @author isard
 */
public class Ventana_Herramienta3 extends javax.swing.JFrame {

    /**
     * Creates new form Ventana_Herramienta3
     */
    public Ventana_Herramienta3() {
        initComponents();
    }

    private String correoUsuario;
    public Ventana_Herramienta3(String correo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/brochapremiumprensada.jpg"))); // NOI18N
        ...
        jLabelProducto.setText("Brocha Premium Prensada");

        jTextAreaDescripcion.setColumns(20);
        jTextAreaDescripcion.setRows(5);
        jTextAreaDescripcion.setText("La brocha perfecta para el \nprofesional que quiere conseguir \nprecisión en el recorte y un \nacabado muy fino.");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(100, 100, 100)
                .addComponent(jLabelProducto, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(layout.createSequentialGroup()
                .addGap(140, 140, 140)
    ...
    private void jButtonCarritoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCarritoActionPerformed
        ...
        vc.recibirDatos5(dni, nombre, cantidad, precio);
        vc.setVisible(true);
        this.dispose();
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Herramienta3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Herramienta3().setVisible(true);
            }
        });
    }
