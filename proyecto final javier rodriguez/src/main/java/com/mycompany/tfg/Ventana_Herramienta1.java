 ...
 * @author isard
 */
public class Ventana_Herramienta1 extends javax.swing.JFrame {

    /**
     * Creates new form Ventana_Herramienta1
     */
    public Ventana_Herramienta1() {
        initComponents();  
    ...
    public Ventana_Herramienta1(String correo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rodillo.jpg"))); // NOI18N
        ...
        jLabelProducto.setText("Rodillo Rendix");

        jTextAreaDescripcion.setColumns(20);
        jTextAreaDescripcion.setRows(5);
        jTextAreaDescripcion.setText("Rodillo premium para lograr mayor \nrendimiento en menos tiempo \ngracias a la eficiencia de su tejido.");
    ...
    private void jButtonCarritoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCarritoActionPerformed
        ...
        vc.recibirDatos3(dni, nombre, cantidad, precio);
        vc.setVisible(true);
        this.dispose();
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Herramienta1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Herramienta1().setVisible(true);
            }
        });
    }
