 ...
 * @author isard
 */
public class Ventana_Pintura3 extends javax.swing.JFrame {

    /**
     * Creates new form Ventana_Pintura3
     */
    public Ventana_Pintura3() {
        initComponents();
        ...
        ImageIcon imagen1 = new ImageIcon(getClass().getResource("/esmaltealuminio.png"));
    ...
    public Ventana_Pintura3(String correo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/esmaltealuminio.png"))); // NOI18N
        ...
        jLabelProducto.setText("Esmalte Aluminio ");

        jTextAreaDescripcion.setColumns(20);
        jTextAreaDescripcion.setRows(5);
        jTextAreaDescripcion.setText("Esmalte aluminio para exteriores");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(100, 100, 100)
                .addComponent(jLabelProducto, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(layout.createSequentialGroup()
                .addGap(50, 50, 50)
    ...
    private void jButtonCarritoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCarritoActionPerformed
        ...
        vc.recibirDatos2(dni, nombre, cantidad, precio);
        vc.setVisible(true);
        this.dispose();
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Pintura3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Pintura3().setVisible(true);
            }
        });
    }
