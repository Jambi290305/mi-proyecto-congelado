 ...
 * @author isard
 */
public class Ventana_Pintura2 extends javax.swing.JFrame {

    /**
     * Creates new form Ventana_Pintura2
     */
    public Ventana_Pintura2() {
        initComponents();
        ...
        ImageIcon imagen1 = new ImageIcon(getClass().getResource("/negro.png"));
    ...
    public Ventana_Pintura2(String correo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/negro.png"))); // NOI18N
        ...
        jLabelProducto.setText("Negro Mate");

        jTextAreaDescripcion.setColumns(20);
        jTextAreaDescripcion.setRows(5);
        jTextAreaDescripcion.setText("Negro mate bueno para interiores");
    ...
    private void jButtonCarritoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCarritoActionPerformed
        ...
        vc.recibirDatos1(dni, nombre, cantidad, precio);
        vc.setVisible(true);
        this.dispose();
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Pintura2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Pintura2().setVisible(true);
            }
        });
    }
